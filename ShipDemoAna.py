...
def myEventLoop(n):
  ...
  for n, track in enumerate(sTree.MCTrack):

    if n < 7:
    
      print("Particle -> " + str(track.GetPdgCode()))
      try:
        print("Mother's pdg code -> " + str(sTree.MCTrack[track.GetMotherId()].GetPdgCode()))
      except:
  ...
  if l > 1:
    ...
    for HNL in sTree.Particles:
      ...
      print(HNL.GetDaughter(0))
      print(HNL.GetDaughter(1))
